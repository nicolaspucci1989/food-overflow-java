...
@DisplayName("Given a simple ar.foodOverflow.recipe")
public class SimpleRecipeTest {
    ...
    @Test
    @DisplayName("can be edited by an author or collaborator ar.foodOverflow.user")
    ...
    @Test
    @DisplayName("can not be edited by a ar.foodOverflow.user, if the ar.foodOverflow.user is not the author or a collaborator")
